<template>
  <div class="homewrapper">
    ...
    <div class="banner">
      ...
      <p>
        <a
          href="https://github.com/nicole618/simple-ui-org"
          target="blank"
          class="homeButton"
          ><svg class="icon" aria-hidden="true">
  ...
  <ul class="simpleUITarit w1200">
    <li>
      ...
      <p>骄傲的采用了Vue 3 Composition API</p>
    </li>
    <li>
      <svg class="icon" aria-hidden="true">
      ...
      <p>源代码使用TypeScript进行编写,增强了代码的可读性和可维护性</p>
    </li>
    <li>
      <svg class="icon" aria-hidden="true">
